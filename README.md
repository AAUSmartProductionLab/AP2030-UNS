...
```bash
    ...
    # Edit .env and set PMC_IP to localhost (default) or to the PC/controller running the PMC. PMC_IP is only relevant when running Planar_Controller on the same PC.
