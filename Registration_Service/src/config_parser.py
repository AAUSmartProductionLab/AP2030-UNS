...
class ConfigParser:
    ...
    def get_mqtt_endpoint(self) -> Dict[str, Any]:
        ...
        """
        interface_config = self.config.get('AssetInterfacesDescription', {}) or {}
    ...
    def get_actions(self) -> List[Dict[str, Any]]:
        ...
        actions_list = interaction_metadata.get('actions', [])
        ...
        for action_item in actions_list:
            # Each action is a dict with the action name as key
    ...
    def get_properties(self) -> List[Dict[str, Any]]:
        ...
        mqtt_config = interface_config.get('InterfaceMQTT', {}) or {}
        interaction_metadata = mqtt_config.get('InteractionMetadata', {}) or {}
        properties_list = interaction_metadata.get('properties', [])
        ...
        for prop_item in properties_list:
            # Each property is a dict with the property name as key
