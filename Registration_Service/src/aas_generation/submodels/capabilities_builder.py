...
class CapabilitiesSubmodelBuilder:
    ...
    def _create_capability_container(self, system_id: str, cap_name: str,
        ...
        # Add CapabilityRelations (placeholder)
        container_elements.append(
    ...
    def _create_realized_by_list(self, system_id: str, cap_name: str,
                                 cap_config: Dict) -> model.SubmodelElementList:
        """
    ...
    def _create_property_set(self, cap_config: Dict) -> model.SubmodelElementCollection:
        """
    ...
    def _create_property_container(self, prop: Dict) -> model.SubmodelElementCollection:
        """
