...
class AasService {
  ...
  buildInstanceConfigYaml(orderIds, instanceIds) {
    ...
    lines.push(`${I}${I}${I}${I}    semantic_id: "cssx:On"`);
    lines.push(`${I}${I}${I}${I}    parameters:`);
    lines.push(`${I}${I}${I}${I}        -   name: "Product"`);
    lines.push(`${I}${I}${I}${I}            externalRef: "css:Product"`);
    lines.push(`${I}${I}${I}${I}        -   name: "Transport"`);
    lines.push(`${I}${I}${I}${I}            externalRef: "cssx:Transport"`);
    lines.push(`${I}${I}${I}${I}-   key: "ProductAt"`);
    lines.push(`${I}${I}${I}${I}    semantic_id: "cssx:ProductAt"`);
    lines.push(`${I}${I}${I}${I}    parameters:`);
    lines.push(`${I}${I}${I}${I}        -   name: "Product"`);
    lines.push(`${I}${I}${I}${I}            externalRef: "css:Product"`);
    lines.push(`${I}${I}${I}${I}        -   name: "Location"`);
    lines.push(`${I}${I}${I}${I}            externalRef: "cssx:LocationParameter"`);
    lines.push(`${I}${I}${I}${I}-   key: "Dispensed"`);
    lines.push(`${I}${I}${I}${I}    semantic_id: "cssx:Dispensed"`);
    lines.push(`${I}${I}${I}${I}    parameters:`);
    lines.push(`${I}${I}${I}${I}        -   name: "Product"`);
    lines.push(`${I}${I}${I}${I}            externalRef: "css:Product"`);
    lines.push(`${I}${I}${I}${I}-   key: "Stoppered"`);
    lines.push(`${I}${I}${I}${I}    semantic_id: "cssx:Stoppered"`);
    lines.push(`${I}${I}${I}${I}    parameters:`);
    lines.push(`${I}${I}${I}${I}        -   name: "Product"`);
    lines.push(`${I}${I}${I}${I}            externalRef: "css:Product"`);
    lines.push(`${I}${I}${I}${I}-   key: "Captured"`);
    lines.push(`${I}${I}${I}${I}    semantic_id: "cssx:Captured"`);
    lines.push(`${I}${I}${I}${I}    parameters:`);
    lines.push(`${I}${I}${I}${I}        -   name: "Product"`);
    lines.push(`${I}${I}${I}${I}            externalRef: "css:Product"`);
