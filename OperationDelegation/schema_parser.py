...
- Auto-generated fields (like TimeStamp)
...
class SchemaParser:
    ...
    def extract_message_structure(self, schema_url: str) -> Dict[str, Any]:
        ...
        - auto_fields: Fields that should be auto-generated
...
def determine_field_mappings(
    ...
    Returns:
        ...
        - simple_mappings: Dict of schema_field -> aas_field for non-array fields
