...
from .hoisting import hoist_conditions
...
def optimize_bt(trivial_bt: BehaviorTree) -> BehaviorTree:
    """Apply Step 5 optimization pipeline: hoist -> parameterize -> deduplicate."""
    optimized = hoist_conditions(trivial_bt)
    parameterize_subtrees(optimized)
    optimized.root = deduplicate_subtrees(optimized.root)
    return optimized
