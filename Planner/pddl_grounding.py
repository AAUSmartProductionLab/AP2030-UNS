...
# fondparser lives in prp-scripts/ — add it once for the whole pipeline.
_SCRIPT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)),"pr2", "prp-scripts")
if _SCRIPT_DIR not in sys.path:
    sys.path.insert(0, _SCRIPT_DIR)

from fondparser.grounder import GroundProblem, Operator  # noqa: E402  re-export
from fondparser.formula import (  # noqa: E402  re-export
    And,
    Not,
    Oneof,
    Or,
...
from normalizer import flatten as flatten_oneof  # noqa: E402  re-export
