...
def _compute_rule_distances(
    ...
    def _outcomes_for_action(action: str):
    ...
    graph = build_policy_state_graph(
        rules,
        _outcomes_for_action,
        goal_positive={g.lower() for g in causal.goal_fluents},
        goal_negative={g.lower() for g in causal.goal_neg_fluents},
    )
    return compute_rule_distances_from_graph(rules, graph)
...
def _lookup_action(
    ...
    from .causal import GroundedAction
