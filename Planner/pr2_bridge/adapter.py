...
from pr2_bridge.up_lowering import lower_problem as lower_up_problem
from pr2_bridge.up_lowering import task_to_sas as up_task_to_sas


# ---------------------------------------------------------------------------
# Locate PR2 root (the pr2/ subdirectory next to this file)
# ---------------------------------------------------------------------------
_PR2_ROOT = Path(__file__).resolve().parent.parent / "pr2"
