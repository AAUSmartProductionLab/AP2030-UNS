...
Existing imports like ``from bt_policy.api import policy_to_bt, bt_to_xml``
...
# ── Node types & helpers ──────────────────────────────────────────────
from bt_policy.nodes import (  # noqa: F401
    BTNode,
    BehaviorTree,
    ConditionNode,
    ActionNode,
...
from bt_policy.builder import policy_to_bt  # noqa: F401

# ── XML serialization ────────────────────────────────────────────────
from bt_policy.xml_writer import bt_to_xml, count_bt_nodes  # noqa: F401

# ── Optimization passes ──────────────────────────────────────────────
from bt_policy.optimizer import (  # noqa: F401
    parameterize_subtrees,
    deduplicate_subtrees,
)

# ── Literal utilities (previously private helpers) ────────────────────
from bt_policy.literals import (  # noqa: F401
    parse_predicate,
    strip_negation,
    is_negated,
    normalize_literal,
