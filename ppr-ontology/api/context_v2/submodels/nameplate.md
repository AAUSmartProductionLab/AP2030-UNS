...
| `ContactInformation` | `SubmodelElementCollection` | — | MANDATORY (IDTA 02002 style) |
...
```json
{
  ...
  "submodelElements": [
    ...
    },
    {
      ...
      "value": [
        {"modelType": "Property", "idShort": "Street",   "valueType": "xs:string", "value": "<street>"},
        {"modelType": "Property", "idShort": "Zipcode",  "valueType": "xs:string", "value": "<zip>"},
        {"modelType": "Property", "idShort": "CityTown", "valueType": "xs:string", "value": "<city>"}
      ]
    },
    {
      "modelType": "Property",
